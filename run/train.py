...
from src.data import Table2TextDataLoader
from src.module import Table2TextModule
...
def main(args):
    ...
    tokenizer = AutoTokenizer.from_pretrained('resource/tokenizer/kobart-base-v2(ttt)')

    logger.info(f'[+] Load Dataset')
    train_dataloader = Table2TextDataLoader("resource/data/nikluge-2022-table-train.jsonl", tokenizer, args.batch_size)
    valid_dataloader = Table2TextDataLoader("resource/data/nikluge-2022-table-dev.jsonl", tokenizer, args.valid_batch_size)
    ...
    lightning_module = Table2TextModule(
        model,
        total_steps,
